...
import {
  ...
  useForceUpdate,
  useNavItem
} from "./chunk-BOTAZRGZ.js";
import {
  Button_default
} from "./chunk-UNWUEAIP.js";
import {
...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-MTJ3AR24.js";
import {
  qsa,
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-623STZFN.js";
import {
  Spinner_default
} from "./chunk-2YZBNQUO.js";
import {
  DEFAULT_BREAKPOINTS,
...
var ModalDialog = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames46.default)(dialogClass, className, size && `${bsPrefix}-${size}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
...
var Modal = React60.forwardRef(({
  ...
  const renderBackdrop = (0, import_react24.useCallback)((backdropProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...backdropProps,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react27.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime71.jsxs)(import_jsx_runtime70.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react29.cloneElement)(children, triggerProps), (0, import_jsx_runtime69.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React71.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames58.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames59.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React72.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime75.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var SplitButton = React77.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
...
var TabPanel = React79.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabContent = React82.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Table = React84.forwardRef(({
  ...
  const classes = (0, import_classnames66.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React86.forwardRef((props, ref) => (0, import_jsx_runtime91.jsx)(Fade_default, {
  ...props,
  ref,
